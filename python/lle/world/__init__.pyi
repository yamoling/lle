...
class World:
    ...
    def agents_positions(self) -> builtins.list[tuple[builtins.int, builtins.int]]:
        ...
        """
    @property
    def gems(self) -> builtins.list[tiles.Gem]:
        r"""
        All the gems of the environment.
        """
    @property
    def lasers(self) -> builtins.list[tiles.Laser]:
        r"""
        Every laser tile in the world.
        """
    @property
    def laser_sources(self) -> builtins.list[tiles.LaserSource]:
        r"""
    ...
    def start_pos(self) -> builtins.list[tuple[builtins.int, builtins.int]]:
        ...
        """
    @property
    def agents(self) -> builtins.list[agent.Agent]:
        r"""
...
class Action(enum.Enum):
    ...
    @staticmethod
    def from_delta(dx: builtins.int, dy: builtins.int) -> Action: ...
    def __hash__(self) -> builtins.int: ...
    def __repr__(self) -> builtins.str: ...
