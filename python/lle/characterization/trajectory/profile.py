...
`TrajectoryProfile` collects the scalar and small-collection properties that
...
class TrajectoryProfile:
    ...
    @staticmethod
    def from_graph(graph: TemporalDependencyGraph):
    ...
    @property
    def has_mutual_help(self):
        return any(len(c) > 1 for c in self.strongly_connected_components)
