...
from .. import tiles
from ..observations import ObservationType, ObservationTypeLiteral
from ..types import Position
from ..world import World
from .env import LLE
from .extras_generators import ExtraGenerator, LaserSubgoal, MultiGenerator, NoExtras
from .reward_strategy import MultiObjective, PotentialShapedLLE, SingleObjective
...
class Builder:
    def __init__(self, world: World):
        ...
        self._death_strategy: Literal["end", "respawn"] = "end"
    ...
    def obs_type(self, obs_type: ObservationTypeLiteral | ObservationType):
        """
    ...
    def state_type(self, state_type: ObservationTypeLiteral | ObservationType):
        """
        Set the state type of the environment (set to ObservationType.STATE by default).
        """
        if isinstance(state_type, str):
            state_type = ObservationType.from_str(state_type)
